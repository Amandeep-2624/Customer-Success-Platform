...
function EscalationMatrix({ projectId, role }) {
  ...
  function OperationalEscalationTable({ escalationData }) {
    const operationalEscalations = escalationData.filter(
      (entry) => entry.escalationType === "Operational"
    );
                  ...
                  <th>
                    ...
                    <td>
                      <button
                        ...
                        onClick={() => deleteEscalation(entry._id)}
                      >
                        Delete
                      </button>
                    </td>
  ...
  function FinancialEscalationTable({ escalationData }) {
    const financialEscalations = escalationData.filter(
      (entry) => entry.escalationType === "Financial"
    );
  ...
  function TechnicalEscalationTable({ escalationData }) {
    const technicalEscalations = escalationData.filter(
      (entry) => entry.escalationType === "Technical"
    );
        ...
        <>
          ...
          <form onSubmit={handleSubmit} className="FormContainer">
            <label>
              ...
              >
                <option  className="input-field" value="" disabled>--Select--</option>
                <option  className="input-field" value="Technical">Technical</option>
                <option  className="input-field" value="Operational">Operational</option>
                <option  className="input-field" value="Financial">Financial</option>
              </select>
            </label>
            <label>
              Escalation Level:
              <input
                ...
                type="number"
                name="escaltionLevel"
                value={newEscalation.escaltionLevel}
                onChange={handleInputChange}
              />
            </label>
            <label>
            ...
            <div className="addbtn">
              <button className="AddEntry" type="submit">
                Add
              </button>
            </div>
          </form>
